...
static void cmd_color(const char *args) {
    ...
    if (strcmp(args, "red") == 0) color = 0xFF4444;
    else if (strcmp(args, "green") == 0) color = 0x00FF88;
    else if (strcmp(args, "blue") == 0) color = 0x4488FF;
    else if (strcmp(args, "yellow") == 0) color = 0xFFDD00;
    else if (strcmp(args, "cyan") == 0) color = 0x00DDFF;
    else if (strcmp(args, "white") == 0) color = 0xFFFFFF;
    else if (strcmp(args, "pink") == 0) color = 0xFF66AA;
    else if (strcmp(args, "orange") == 0) color = 0xFF8844;
    else {
        fb::set_color(0xFF4444, 0x000000);
        fb::print("  [NO] ");
        fb::set_color(0xFFFFFF, 0x000000);
        fb::println("Invalid color. Available: red green blue yellow cyan white pink orange");
        return;
    }
...
static void process_command(char *input) {
    ...
    else if (strcmp(cmd, "clear") == 0) fb::clear(0x000000);
